...
export class DoActionsRule extends PlayerTurnRule {
  ...
  getPlayerMoves(): MaterialMove[] {
    ...
    playerFamilies.forEach((family) => {
      ...
      moves.push(...this.expandFamilyHelper.addMovesForExpandFamily(tile?.id as Tile, tile!.location.y!))
      moves.push(...this.exchangeFamilyHelper.addMovesForExchangeFamily(tile!.location.y!))
    })
    tiles.forEach((tile) => {
